...
function Homepage({ city, chosenCity, setChosenCity }) {
    ...
    const filterByTitle = (title) => {
        ...
        // Filter the filteredCity array by the selectedTitle
        const filteredByTitle = filteredCity.filter((item) =>
    ...
    const filteredByTitle = filterByTitle(selectedTitle);
        ...
        <div className="h_overlay">
            ...
            >
                <Grid className="main__listItems--grid" container spacing={2}>
                    {filteredByTitle.map((item, index) => (
